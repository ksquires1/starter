...
// const incompleteTast = data.filter(user => user.userId === 3, 7, 8);
// const incompleteTast = data.filter(user => user.completed === false);
...
class BonusNight {
  ...
  greet() {
    return `This game is ${this.name}`;
  }
  cost () {
    return `The price of this game is ${this.price}`;
  }
}
